...
nohup java -jar \
    -javaagent:/home/ec2-user/scouter/agent.java/scouter.agent.jar -Dobj_name=MY-INTRODUCE-WAS-8081 -DScouter.config=/home/ec2-user/scouter/agent.java/conf/myintroduce8081.conf \
